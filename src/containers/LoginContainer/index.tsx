                    ...
                    <div className="flex rounded-lg shadow-lg w-full sm:w-3/4 lg:w-1/2 bg-white sm:mx-0">
                        ...
                        <div className="flex flex-col w-full md:w-1/2 p-4">
                            <div className="flex flex-col flex-1 justify-center mb-8">
                                <h1 className="text-4xl text-center font-thin">Login Page</h1>
                                <div className="w-full mt-4">
                                    ...
                                    <div className="text-center mt-4">
                                        <p className="mt-2 text-xs">
                                            ...
                                            <Link className='text-blue-500 hover:text-blue-700 font-semibold hover:underline text-blue-dark' to={'/register'}> Register Here</Link>
                                            {/* <a href="#" className="text-blue-500 hover:text-blue-700 font-semibold hover:underline text-blue-dark">
                                                Register Account
                                            </a> */}
                                        </p>
                                    </div>
